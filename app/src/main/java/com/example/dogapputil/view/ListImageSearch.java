...
import com.example.dogapputil.viewModel.ListDogWithImageViewModel;
import java.util.ArrayList;
import java.util.List;



public class ListImageSearch extends Fragment {


    private DogListAdapter  dogListAdapter = new DogListAdapter(new ArrayList<>());
    private ListDogWithImageViewModel viewModel;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel = ViewModelProviders.of(this).get(ListDogWithImageViewModel.class);
    ...
    private void updateList() {
        viewModel.dogs.observe(this, breedResultsList -> {
            if(breedResultsList !=null && breedResultsList instanceof List) {
                listDogs.setVisibility(View.VISIBLE);
                dogListAdapter.updateDogListImage(breedResultsList);
            }
        });
